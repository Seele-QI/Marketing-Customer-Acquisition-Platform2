...
VIDEO_SEGMENT_COST = 250          # 每 20s 视频段
VIDEO_CLONE_VOICE_COST = 50       # 每次音色克隆
VIDEO_CREATION_COST = VIDEO_SEGMENT_COST  # 向后兼容别名（单价）
...
CHAT_COST = 3
# Sonetto 计量扣费占位（实际 cost 由定价引擎传入，公开 consume 不可用此 scene）
