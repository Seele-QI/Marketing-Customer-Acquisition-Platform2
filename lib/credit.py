...
VIDEO_SEGMENT_COST = 250          # 每 20s 视频段（旧数字人口播）
VIDEO_CLONE_VOICE_COST = 10       # 每次音色克隆
VIDEO_CREATION_COST = VIDEO_SEGMENT_COST
VIDEO_IMAGE_TO_VIDEO_COST = 40
VIDEO_MASHUP_COST = 50
PROMO_VIDEO_SEGMENT_COST = 450    # 宣传视频每 15s（Seedance）
PROMO_STORYBOARD_COST = 50
COPY_EXTRACT_COST = 5
CHAT_COST = 3
# 文案创作 LLM（可变 scene copywriting_llm）
...
PROMO_VIDEO_SEGMENT_PLACEHOLDER = 450
AI_LLM_COST_PLACEHOLDER = 1
MAX_LLM_COST = 50_000
