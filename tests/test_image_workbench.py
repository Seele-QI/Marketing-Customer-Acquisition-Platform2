...
def test_image_workbench_pipeline_uses_text_to_image_without_references(
    ...
    rh.upload_image_file.assert_not_awaited()
...
def test_image_workbench_pipeline_uploads_references_once_and_uses_image_to_image(
    ...
    assert rh.upload_image_file.await_args_list[0].args == ("one.png",)
    assert rh.upload_image_file.await_args_list[1].args == ("two.png",)
